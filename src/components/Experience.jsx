...
const ExperienceCard = ({experience, source_code_link}) =>(
  ...
  <div className="w-10 h-10 rounded-full-flex justifty-center items-center cursor-pointer"
  onClick={() => window.open(experience.source_code_link)}
  >
    <img 
      src={github}
      alt='source_code'
